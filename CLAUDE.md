...
> Each app defines its own additional rules in its own CLAUDE.md.
...
> Full rules: `apps/web/.claude/CLAUDE.md`
>
...
- Styles: **SCSS** scoped to each component using BEM naming
...
- Use /apps/web/src/app/styles for shared styles and design tokens always — do not hardcode values in components

---

### `/apps/api` — NestJS backend

> Full rules: `apps/api/CLAUDE.md`
>
> **When editing any file inside `/apps/api/**`, apply those rules with priority.**

Key rules summary:

- Runtime: **Node.js** with TypeScript and **NestJS** framework
- Follow **REST** conventions for endpoint naming
- Validate all inputs at the controller layer using DTOs and `class-validator`
- Never expose internal errors to the client response
- Use environment variables for secrets — never hardcode them

---

## How to resolve rule conflicts
